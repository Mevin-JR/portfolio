      ...
      <div className="flex items-center gap-4">
        ...
        {loading && (
          <div>
            <svg
              aria-hidden="true"
              className="w-4 h-4 animate-spin text-gray-200 fill-cyan-400"
              viewBox="0 0 100 101"
              fill="none"
      ...
      <div className="flex w-fit">
        {link ? (
          <div
            ...
            bg-cyan-400/5 border border-cyan-400/50 rounded-l p-2"
          >
            <p
              className={`text-sm text-cyan-400 select-text overflow-x-auto scrollbar-hide text-nowrap ${
                loading ? "blur-sm" : ""
              }`}
            >
              {link}
          ...
          <div className="w-[250px] outline-none bg-cyan-400/5 border border-cyan-400/50 rounded-l p-2">
            <p
              className={`text-sm text-gray-400 select-text overflow-x-auto scrollbar-hide text-nowrap ${
                loading ? "blur-sm" : ""
              }`}
            >
              No link available
        ...
        {showLinkEditPopup && (
          <LinkEditPopup
            linkName={linkName}
            currentLink={link}
            setShowLinkEditPopup={setShowLinkEditPopup}
